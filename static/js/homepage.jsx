function Display(){
    ...
    return (
        <div className="container d-flex justify-content-between vh-100">
            <div className="col-7 welcome-text d-flex flex-column justify-content-center m-1">
                <h1>Welcome to the Cosplay Planner!</h1><br/>
                <p>
            ...
            <div className="col-5 card-group d-flex flex-column justify-content-evenly">
                <div className="all-card m-1 p-1 rounded d-flex flex-column justify-content-center" >
                    <div className="d-flex flex-column align-items-center" >
                        <h4 className="">All Anime</h4>
                ...
                <div className="all-card m-1 p-1 rounded d-flex flex-column justify-content-center">
                    <div className="d-flex flex-column align-items-center">
                        <h4 className="">All Characters</h4>
